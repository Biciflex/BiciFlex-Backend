package pe.edu.biciflex.userservice.application.internal.services;
...
import pe.edu.biciflex.userservice.application.internal.services.outboundservices.ExternalAuthService;
import pe.edu.biciflex.userservice.application.internal.services.outboundservices.resources.RegisterRequest;
import pe.edu.biciflex.userservice.domain.exceptions.ResourceNotFoundException;
import pe.edu.biciflex.userservice.domain.exceptions.ResourceValidationException;
import pe.edu.biciflex.userservice.domain.model.User;
import pe.edu.biciflex.userservice.domain.services.UserService;
import pe.edu.biciflex.userservice.infrastructure.persistence.UserRepository;
